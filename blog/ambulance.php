...
<div class="container-fluid">
    ...
    <!---section---->
    <div>
        <img  align="center" class="img-fluid ml-5" src="upload/Ambulance%20Service%20of%20Dhaka.jpg">
...
//            echo'select';
        ...
        <h4 class=" text-center bg-dark font-weight-bold text-white ml-5">ambulance </h4>
            ...
            <div class="row ml-5" >
                ...
                <div class="card float-left border-0">
                    ...
                    <div class="card-body float-left">
                        ...
                        <h5><a href="" class="font-weight-bold">  <?php echo $result['name'] ?></a></h5>
                        <h6 class="font-weight-bold"> Location:   <?php echo $result['location'] ?> </h6>
                        <h6>phone:  <?php echo $result['mobile'] ?></h6>
                    <br>
                        <br>
