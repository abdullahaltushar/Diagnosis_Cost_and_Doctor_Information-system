...
//            echo'select';
        ...
        $sql="SELECT * FROM  blood WHERE blood='AB+'";
        ...
        <h4 class=" text-center bg-dark font-weight-bold text-white ml-5">AB+(Positive) </h4>
            ...
            <div class="row ml-5" >
                ...
                <div class="card float-left border-0">
                    ...
                    <div class="card-body float-left">
                        ...
                        <h6 class="font-weight-bold">Email:<?php echo $result['email'] ?> </h6>
                        <h6>location <?php echo $result['location'] ?>
                        </h6><h6>phone : <?php echo $result['number'] ?><br>
                        </h6>
                        <h6>
