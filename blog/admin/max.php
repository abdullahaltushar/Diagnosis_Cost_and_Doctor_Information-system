...
<h4 align="center"><a class="text-success" href="addmax.php">ADD MAX</a></h4>
<?php
$hostname='localhost';
$username='root';
$password='';
...
<table align="center" class="table table-hover" id="myTable" style="border:solid 1px black">
    ...
    <?php while($result=mysqli_fetch_assoc($resource_id)){ ?>
        ...
        <tr align="center">
            ...
            <td><button class="btn-danger btn"><a href="max_delete.php?id=<?php echo $result['id']; ?>" class="text-white">Delete</a></button></td>
            <td><button class="btn-success btn"><a href="max_update.php?id=<?php echo $result['id']; ?>" class="text-white">Update</a></button></td>
