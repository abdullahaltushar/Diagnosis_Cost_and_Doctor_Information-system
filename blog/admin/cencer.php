...
<div class="container-fluid">
    ...
    <h4 class="text-center font-drak;"><a href="addcencer.php">
            Add Oncologists
        </a>
    </h4>
    <h4 class=" text-center bg-dark font-weight-bold text-white ml-5">ক্যান্সার বিশেষজ্ঞ  (Oncologists)</h4>
