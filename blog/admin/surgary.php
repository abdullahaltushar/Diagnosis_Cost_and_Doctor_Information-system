...
<div class="container-fluid">
    ...
    <h4 class="text-center font-drak;"><a href="addsurgry.php">
            Add surgry
        </a>
    </h4>
    <h4 class=" text-center bg-dark font-weight-bold text-white ml-5">সার্জারী বিশেষজ্ঞ(Hospitals, Physicians and surgeons) </h4>
