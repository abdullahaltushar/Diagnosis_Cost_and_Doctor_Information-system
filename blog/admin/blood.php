...
<table align="center" class="table table-hover" id="myTable" style="border:solid 1px black">
    ...
    <tr align="center" >
        <th class="slno" scope="col">Name</th>
        <th class="testname" scope="col">Email</th>
        <th class="taka" scope="col">location</th>
        <th class="slno" scope="col">number</th>
        <th class="testname" scope="col">group</th>
        <th class="taka" scope="col">Gender</th>
    ...
    <?php while($result=mysqli_fetch_assoc($resource_id)){ ?>
        ...
        <tr align="center">
            ...
            <td><button class="btn-danger btn"><a href="blood_delete.php?id=<?php echo $result['id']; ?>" class="text-white">Delete</a></button></td>
            <td><button class="btn-success btn"><a href="blood_update.php?id=<?php echo $result['id']; ?>" class="text-white">Update</a></button></td>
