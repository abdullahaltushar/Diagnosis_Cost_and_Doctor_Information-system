...
<div class="container-fluid">
    ...
    <h4 class="text-center font-drak;"><a href="addendocrinology.php">
            Add endocrinology
        </a>
    </h4>
    <h4 class=" text-center bg-dark font-weight-bold text-white ml-5">endocrinology </h4>
