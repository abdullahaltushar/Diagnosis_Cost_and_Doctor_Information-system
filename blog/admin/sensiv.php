...
<table align="center" class="table table-hover" id="myTable" style="border:solid 1px black">
    ...
    <?php while($result=mysqli_fetch_assoc($resource_id)){ ?>
        ...
        <tr align="center">
            ...
            <td><button class="btn-danger btn"><a href="sensiv_delete.php?id=<?php echo $result['id']; ?>" class="text-white">Delete</a></button></td>
            <td><button class="btn-success btn"><a href="sensiv_update.php?id=<?php echo $result['id']; ?>" class="text-white">Update</a></button></td>
