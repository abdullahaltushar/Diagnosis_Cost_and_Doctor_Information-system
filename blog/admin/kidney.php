...
<div class="container-fluid">
    ...
    <h4 class="text-center font-drak;"><a href="addkidney.php">
            Add  Kidney pathologist
        </a>
    </h4>
    <h4 class=" text-center bg-dark font-weight-bold text-white ml-5">কিডনী রোগ বিশেষজ্ঞ (Kidney pathologist) </h4>
