...
//            convert jpg
    ...
    if (in_array($filecheck, $fileextstored)) {
        ...
        $sql = "INSERT INTO `liver`( `name`, `department`, `title`, `education`, `appointment`, `camber`, `serial`, `time`, `gender`, `image`, `off`) VALUES ('$name','$department','$title','$education','$medical','$camber','$serial','$time','$gender','$destinationfile','$off')";
        $query = mysqli_query($con, $sql);
        if ($query) {
            echo "select";
            header('Location: liver.php');
        } else {
