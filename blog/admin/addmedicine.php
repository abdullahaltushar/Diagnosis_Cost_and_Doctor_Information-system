...
//            convert jpg
    ...
    if (in_array($filecheck, $fileextstored)) {
        ...
        $sql = "INSERT INTO `medicine`( `name`, `department`, `title`, `education`, `appointment`, `camber`, `serial`, `time`, `gender`, `image`, `off`) VALUES ('$name','$department','$title','$education','$medical','$camber','$serial','$time','$gender','$destinationfile','$off')";
