...
<div class="container-fluid">
    ...
    <h4 class="text-center font-drak;"><a href="addliver.php">
            Add  Liver pathologist
        </a>
    </h4>
    <h4 class=" text-center bg-dark font-weight-bold text-white ml-5">লিভার রোগ বিশেষজ্ঞ (
        Liver pathologist ) </h4>
