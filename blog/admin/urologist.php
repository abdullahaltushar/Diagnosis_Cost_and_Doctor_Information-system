...
<div class="container-fluid">
    ...
    <h4 class="text-center font-drak;"><a href="addurologist.php">
            Add urologist
        </a>
    </h4>
    <h4 class=" text-center bg-dark font-weight-bold text-white ml-5"> urologist </h4>
