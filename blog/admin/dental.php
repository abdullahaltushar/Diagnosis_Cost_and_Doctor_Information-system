...
<div class="container-fluid">
    ...
    <h4 class="text-center font-drak;"><a href="adddental.php">
            Add dental
        </a>
    </h4>
    <h4 class=" text-center bg-dark font-weight-bold text-white ml-5">ডেন্টিস্ট

        কসমেটিক সার্জন(Dentist
        Cosmetic Surgeons)</h4>
