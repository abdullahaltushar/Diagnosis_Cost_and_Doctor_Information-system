...
<div class="container-fluid">
    ...
    <h4 class="text-center font-drak;"><a href="addpsychiatrists.php">
            Add Psychiatrists
        </a>
    </h4>
    <h4 class=" text-center bg-dark font-weight-bold text-white ml-5">মানসিক রোগ বিশেষজ্ঞ (Psychiatrists and psychotherapists)</h4>
