...
<html>
<head>
    <title>হৃদরোগ ও মেডিসিন বিশেষজ্ঞ </title>
...
<h4 class="text-center font-drak;"><a href="addcardiologist.php">
  Add  cardiologist
</a>
</h4>
    <h4 class=" text-center bg-dark font-weight-bold text-white ml-5">হৃদরোগ ও মেডিসিন বিশেষজ্ঞ </h4>
        ...
        <div class="row ml-5" >
            ...
            <div class="card float-left border-0">
                ...
                <div class="card-body float-left">
                    ...
                    <p>Department of <?php echo $result['department'] ?><br><?php echo $result['medical'] ?><br>
