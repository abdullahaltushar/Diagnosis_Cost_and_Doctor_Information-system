...
<div class="container-fluid">
    ...
    <h4 class="text-center font-drak;"><a href="addpain.php">
            Add pain
        </a>
    </h4>
    <h4 class=" text-center bg-dark font-weight-bold text-white ml-5">গবাত, ব্যাথা ও প্যারালাইসিস বিশেষজ্ঞ (Specialists in Arthritis, Pain and Paralysis) </h4>
